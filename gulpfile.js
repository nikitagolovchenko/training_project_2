...
function resources() {
    return gulp.src(options.resources.src, {
        ...
        .pipe(gulp.dest(options.resources.dest))
        .pipe(browserSync.stream())
}
...
function watch() {
    ...
    gulp.watch(options.resources.src, resources);
}

gulp.task('styles', styles);
gulp.task('scripts', scripts);
gulp.task('watch', watch);
gulp.task('build', gulp.series(gulp.parallel(styles, scripts, html, resources)));
